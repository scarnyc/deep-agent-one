...
def mock_settings_with_langsmith() -> Settings:
    ...
    settings.LANGSMITH_API_KEY = "lsv2_test_key_1234567890abcdef"
...
class TestLangSmithSetup:
    """Test LangSmith integration setup and configuration."""
...
class TestLangSmithIntegrationValidation:
    """Test validation and error handling in LangSmith setup."""
