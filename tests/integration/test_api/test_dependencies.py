"""
Integration tests for FastAPI dependencies module.

Tests thread safety of singleton AgentService management,
including concurrent access and reset operations with real FastAPI app.
"""
...
class TestGetAgentService:
    """Integration tests for get_agent_service() singleton pattern."""

    def test_returns_agent_service_instance(self) -> None:
        """Test that get_agent_service returns an AgentService instance."""
        with patch("backend.deep_agent.api.dependencies.AgentService") as mock_agent_service:
    ...
    def test_raises_initialization_error_on_failure(self) -> None:
...
class TestResetAgentService:
    """Integration tests for reset_agent_service() function."""
...
class TestConcurrentAccess:
    """Integration tests for thread safety of singleton management.
    ...
    def test_concurrent_get_creates_only_one_instance(self) -> None:
        ...
        def mock_agent_service_init() -> None:
    ...
    def test_concurrent_reset_is_safe(self) -> None:
    ...
    def test_reset_during_get_is_thread_safe(self) -> None:
    ...
    def test_lock_prevents_simultaneous_instance_creation(self) -> None:
    ...
    def test_get_after_reset_creates_new_instance(self) -> None:
...
class TestAgentServiceInitializationError:
    """Integration tests for AgentServiceInitializationError exception."""
...
class TestLockExists:
    """Integration tests to verify lock infrastructure exists."""
...
class TestVersionCounter:
    """Integration tests for version counter functionality.
    ...
    def test_version_is_non_negative_integer(self) -> None:
    ...
    def test_version_increments_on_creation(self) -> None:
    ...
    def test_version_increments_after_reset_and_get(self) -> None:
    ...
    def test_version_does_not_increment_on_cached_get(self) -> None:
