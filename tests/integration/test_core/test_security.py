...
in logs and API responses with real SECRET_PATTERNS matching.
"""
...
class TestSanitizeErrorWithMetadataIntegration:
    """Integration tests for error message sanitization with metadata."""
...
class TestMaskApiKeyIntegration:
    """Integration tests for API key masking."""

    def test_long_key_shows_prefix_suffix(self) -> None:
        """Test that long keys show prefix and suffix."""
        key = "sk-proj-1234567890abcdefghijklmnop"  # pragma: allowlist secret
