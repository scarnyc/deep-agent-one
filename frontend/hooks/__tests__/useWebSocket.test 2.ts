...
describe('useWebSocket Hook', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should use custom WebSocket URL when provided', () => {
      ...
      // Verify URL was used (check mock WebSocket constructor)
  ...
  describe('Issue 46: Max Reconnection Attempts Circuit Breaker', () => {
    it('should stop reconnecting after max attempts reached', async () => {
      ...
      // Simulate abnormal disconnections (code !== 1000)
      for (let i = 1; i <= maxReconnectAttempts + 1; i++) {
        act(() => {
          const ws = (global as any).WebSocket.mock.instances[0];
          ws.close(1006, 'Abnormal closure'); // 1006 = abnormal
        });
      ...
      const lastError = onError.mock.calls[onError.mock.calls.length - 1][0];
